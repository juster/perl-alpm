...
Unimplemented functions:
  ...
  alpm_checkdeps, alpm_find_satisfier, alpm_find_dbs_satisfier,
  alpm_dep_compute_string, alpm_trans_interrupt, alpm_checkconflicts,
  alpm_compute_md5sum, alpm_sync_newversion, alpm_delta_... functions
